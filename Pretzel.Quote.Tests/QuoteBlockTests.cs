...
namespace Pretzel.Quote.Tests
{
    ...
    public class QuoteBlockTests
    {
        ...
        public void TestCharacterRange()
        {
            ...
            Template templateOk1 = Template.Parse("{% quote auth'or %}content{% endquote %}");
            Template templateOk2 = Template.Parse("{% quote auth-or %}content{% endquote %}");
            Template templateOk3 = Template.Parse("{% quote Teal'c, Stargate SG-1 - 7x21 %}content{% endquote %}");
